...
import { updateCartQuantity, removeFromCart } from '../../store/Reducers/action/cartAction';
...
class Item extends Component {
  ...
  render() {
      ...
      return (
          ...
          <div className="row">
              <div className="col-xs-2"><img className="img-responsive" src={item.product.filename} />
              </div>
